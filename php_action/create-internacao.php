...
//$sql = "INSERT INTO users(name, email, password) VALUES(:name, :email, :passwordHash)";
	$sql = "INSERT INTO internacao (interna_data, interna_admissao, interna_clinica, interna_leito, interna_diagnostico, interna_pac_id, interna_status, interna_usu_id) 
	VALUES (:data, :admissao, :clinica, :leito, :diagnostico, :pac_id, :status, :usuario)";
	...
	if ($stmt->execute())
	{
		...
		if ($stmt->execute())
		{
			$_SESSION['usu_msg'] = "Internação adicionada com sucesso!";
